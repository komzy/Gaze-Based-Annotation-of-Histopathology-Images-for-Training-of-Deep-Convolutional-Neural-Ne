...
## Results
Results for both YOLOv3 and Faster R-CNN can be found [here](https://1drv.ms/u/s!As_geBXhgCy1rz2y3zLqQZ5a_PQ3?e=2n7O1W). Metrics can be generated by this [repo](https://github.com/Cartucho/mAP) using the detection results .txt file  
