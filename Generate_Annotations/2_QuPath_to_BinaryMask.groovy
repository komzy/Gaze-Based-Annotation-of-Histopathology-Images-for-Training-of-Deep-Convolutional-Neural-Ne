...
double requestedPixelSizeMicrons = 0.5
...
def pathOutput = QPEx.buildFilePath(QPEx.PROJECT_BASE_DIR, 'exported_tiles_new3')
...
downsample = 1 // CHANGE MAHAD CHANGE!!!!!
...
requests.parallelStream().forEach { request ->
    ...
    if (exportAnnotationLabelledImage) {
        ...
        if (count > 0 || !skipUnannotatedTiles) {
            ...
            // Write the mask
            def fileOutput = new File(pathOutput, name + '_labels.png')
